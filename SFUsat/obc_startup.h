...
#ifndef SFUSAT_OBC_STARTUP_H_
#define SFUSAT_OBC_STARTUP_H_
...
#define SFUSAT_LOG_PBIST_FAILS_CHUNK_1 1	// if 1, execute the first chunk of PBIST result logging (required because TI's user code sections are awkwardly placed)
...
void sfu_startup_logs(void);	/* log various things at startup */
